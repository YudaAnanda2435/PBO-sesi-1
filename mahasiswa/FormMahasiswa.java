...
void loadData(){
    try{
        ...
        String sql = "SELECT * FROM mahasiswa2";
...
void simpanData(mahasiswa2 M){
    try{
        Connection cn = new connecDB().getConnect();
        Statement st = cn.createStatement();
        String sql = "INSERT INTO mahasiswa2 (NIM, Nama, Alamat) " +
...
void hapusData(String nim){
    try{
        Connection cn = new connecDB().getConnect();
        Statement st = cn.createStatement();
        String sql = "DELETE FROM mahasiswa2 WHERE NIM = '"+nim+"'";
        int result = st.executeUpdate(sql);
        cn.close();
...
void ubahData(mahasiswa2 M, String nim) {
    try{
        Connection cn = new connecDB().getConnect();
        Statement st = cn.createStatement();
        String sql = "UPDATE mahasiswa2 SET NIM='"+  M.getNIM()+"', Nama ='" + M.getNama()+"', Alamat='" + M.getAlamat()+"' WHERE NIM='" +nim+"'";
        int result = st.executeUpdate(sql);
        cn.close();
